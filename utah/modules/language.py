...
__help__ = """
Get the available list of language in Utah by below commands.
...
Utah will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
